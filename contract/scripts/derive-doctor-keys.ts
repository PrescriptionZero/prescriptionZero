...
// contract's constructor. Run this ONCE before deploying; pass the printed
// public keys as the deploy script's constructor args, and hand each
// doctor their own secret (e.g. via registerDoctorSecret in the backend,
// or a per-doctor .env value).
//
//   npx tsx scripts/derive-doctor-keys.ts
//
...
console.log('\n# Public keys — pass these as the constructor args when deploying');
